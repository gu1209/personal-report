...
const EDU = {
  master: {
    school:  { zh: '你的大学名称（985）',        en: 'Your University Name (985)' },
    major:   { zh: '你的专业',                   en: 'Your Major' },
    degree:  { zh: '硕士',                      en: 'Master' },
    period:  '2024.09-2027.01',
    gpa:     { zh: 'GPA：X.XX（专业排名），**奖学金情况**', en: 'GPA: X.XX (Major Ranking), **Scholarship Info**' },
    courses: { zh: '主修课程：**课程一**、课程二、**课程三**、课程四、课程五', en: 'Key Courses: **Course 1**, Course 2, **Course 3**, Course 4, Course 5' },
  },
  bachelor: {
    school:  { zh: '你的本科学校（211）',        en: 'Your Undergraduate School (211)' },
    major:   { zh: '你的本科专业',                en: 'Your Bachelor Major' },
...
// ── Skills data ─────────────────────────────────────────────────────────
const SKILLS_ZH = [
  { topic: '专业技能一', body: '描述你的专业技能能力，包括相关工具、技术栈和实际应用经验。突出你的核心优势和独特价值。' },
  { topic: '专业技能二', body: '描述另一项专业技能或能力维度，展示你的多元化和综合能力。' },
  { topic: '软件技能', body: '列出你熟悉的软件工具、办公软件、专业系统等，可以包括版本控制、项目管理、数据分析工具等。' },
  { topic: '专业资质', body: '列出你获得的证书和资格认证，如CPA、CFA、证券从业、基金从业等，注明通过科目或级别。' },
  { topic: '语言能力', body: '说明你的语言水平，如中文母语、英语CET-6、商务沟通能力等。' },
];
const SKILLS_EN = [
  { topic: 'Professional Skill 1', body: 'Describe your professional skills, including relevant tools, tech stack, and practical experience. Highlight your core strengths and unique value.' },
  { topic: 'Professional Skill 2', body: 'Describe another professional skill or competency dimension, showcasing your diversity and comprehensive abilities.' },
  { topic: 'Software Skills', body: 'List software tools, office applications, professional systems you are familiar with, including version control, project management, data analysis tools, etc.' },
  { topic: 'Certifications', body: 'List certificates and qualifications you have obtained, such as CPA, CFA, securities/fund practitioner certificates, with subjects or levels passed.' },
  { topic: 'Languages', body: 'Describe your language proficiency, e.g., native Chinese, CET-6 English, business communication skills, etc.' },
];
...
export default function ResumeExportModal({ isOpen, onClose, experiences, projects, lang }: Props) {
  ...
  const [objective,        setObjective]        = useState(isZh ? '你的求职意向' : 'Your Objective');
  const [age,              setAge]              = useState('25');
  const [location,         setLocation]         = useState(isZh ? '城市' : 'City');
