...
const translations = {
  zh: {
    ...
    hero: { title: '你的名字', subtitle: '专业领域 · 核心技能 · 职业目标', description: '在这里填写你的个人简介，突出你的专业优势和职业特长。', contact: '联系我', github: 'GitHub' },
    about: { title: '关于我', education: '教育背景', intro: '在这里填写你的教育背景和专业特长。突出你的学术成就、专业技能和个人优势。', strengths: '根据你的实际情况填写核心竞争优势，如专业证书、技术能力、项目经验等。', degree: '硕士', university: '你的大学名称', faculty: '学院名称', facultyEn: 'Faculty Name', major: '主修课程列表...', period: '2024.09 - 2027.01（预计）', bachelor: '金融学士', bachelorUniv: '你的本科学校（211）', bachelorFaculty: '学院名称', bachelorMajor: '主修课程列表...', bachelorPeriod: '2020.09 - 2024.06', bachelorGpa: 'GPA: X.XX/5.0，专业排名，奖学金情况' },
    ...
    contact: {
      ...
      message: '寻求相关实习机会。欢迎联系！',
    },
  },
  en: {
    nav: { about: 'About', experience: 'Experience', projects: 'Projects', skills: 'Skills & Certs', now: 'Now', notes: 'Notes', contact: 'Contact' },
    hero: { title: 'Your Name', subtitle: 'Professional Field · Core Skills · Career Goals', description: 'Add your personal introduction here, highlighting your professional strengths and career objectives.', contact: 'Contact Me', github: 'GitHub' },
    about: { title: 'About Me', education: 'Education', intro: 'Add your educational background and professional expertise here. Highlight academic achievements, professional skills, and personal strengths.', strengths: 'List your core competitive advantages based on your situation, such as professional certificates, technical abilities, project experience, etc.', degree: "Master's", university: 'Your University', faculty: 'Faculty Name', major: 'List of major courses...', period: '2024.09 - 2027.01 (expected)', bachelor: 'Bachelor in Finance', bachelorUniv: 'Your Undergraduate School (211)', bachelorFaculty: 'Faculty Name', bachelorMajor: 'List of major courses...', bachelorPeriod: 'Sep 2020 - Jun 2024', bachelorGpa: 'GPA: X.XX/5.0, Major ranking, Scholarship status' },
    ...
    contact: {
      ...
      message: 'Seeking internship opportunities. Feel free to reach out!',
    },
  },
};
...
const experiences = [
  {
    ...
    role: '职位名称',
    roleEn: 'Position Title',
    period: '2024年3月 - 2024年6月',
    periodEn: 'Mar 2024 - Jun 2024',
    highlights: [
      '在这里填写你的工作职责和主要成就，使用STAR法则描述',
      '第二点：描述你完成的具体任务和项目成果',
      '第三点：说明你使用的工具、技术或方法',
      '第四点：量化你的贡献，如效率提升百分比、成本节约等',
    ],
    highlightsEn: [
      'Describe your responsibilities and key achievements here using the STAR method',
      'Point 2: Describe specific tasks completed and project outcomes',
      'Point 3: Explain tools, technologies, or methods you used',
      'Point 4: Quantify your contributions, such as efficiency improvement percentage, cost savings, etc.',
    ],
    highlightsBold: [0, 2],
...
const projects = [
  {
    ...
    subtitle: '项目副标题或一句话描述',
    subtitleEn: 'Project subtitle or one-line description',
    tech: ['技术栈1', '技术栈2', '技术栈3'],
    objective: '在这里填写你的项目目标，说明为什么要做这个项目，要解决什么问题。',
    objectiveEn: 'Add your project objective here, explaining why you did this project and what problem you aimed to solve.',
    methodology: '描述你的研究方法或实现方法，包括算法选择、数据来源、实验设计等。',
    methodologyEn: 'Describe your research methodology or implementation approach, including algorithm selection, data sources, experimental design, etc.',
    design: '详细描述项目的设计思路、架构选择、关键决策和实现细节。',
    designEn: 'Detailed description of project design, architecture choices, key decisions, and implementation details.',
...
const skillsData = {
  ...
  dataTools: ['Pandas', 'NumPy', 'Scikit-learn', 'TensorFlow', 'MySQL', 'Git', 'Docker'],
  finance: ['财务分析', '投资评估', '风险管理', '财务建模'],
  certifications: [
    'CPA：通过科目列表...',
    'CFA：通过级别...',
    '证券从业资格证',
  ...
  certificationsEn: [
    'CPA: X subjects passed',
    'CFA: Level X passed',
    'Securities Practitioner Certificate',
    'Futures Practitioner Certificate',
  ],
  languages: ['中文（母语）', 'English（商务沟通）'],
};
...
const METRICS_ZH = [
  { target: 3,     decimals: 0, suffix: '',   prefix: '',     label: '项目经验' },
  { target: 50,    decimals: 0, suffix: '%',  prefix: '',     label: '效率提升' },
  { target: 100,   decimals: 0, suffix: '%',  prefix: '',     label: '任务完成率' },
  { target: 5,     decimals: 0, suffix: '',   prefix: '证书 ', label: '获取数量' },
  { target: 3.8,   decimals: 1, suffix: '',   prefix: '',     label: 'GPA 专业前20%' },
];
const METRICS_EN = [
  { target: 3,     decimals: 0, suffix: '',   prefix: '',     label: 'Projects' },
  { target: 50,    decimals: 0, suffix: '%',  prefix: '',     label: 'Efficiency Gain' },
  { target: 100,   decimals: 0, suffix: '%',  prefix: '',     label: 'Task Completion' },
  { target: 5,     decimals: 0, suffix: '',   prefix: 'Certs ', label: 'Earned' },
  { target: 3.8,   decimals: 1, suffix: '',   prefix: '',     label: 'GPA Top 20%' },
];
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <a href="#" className="flex items-center gap-2.5 hover:opacity-80 transition">
              <div className="w-9 h-9 bg-gradient-to-br from-primary-500 to-primary-700 rounded-xl flex items-center justify-center text-white text-sm font-bold shadow-md">A</div>
              <span className="font-semibold text-gray-900 tracking-tight">Applicant Name</span>
            </a>
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="flex flex-col md:flex-row gap-14 items-center">
            ...
            <div className="flex-1 space-y-5">
              ...
              <h2 className="text-xl md:text-2xl font-medium leading-relaxed text-primary-600">
              ...
              <div className="flex flex-wrap gap-2.5 pt-1">
                {[
                  lang === 'zh' ? '3年经验' : '3 Years Exp',
                  lang === 'zh' ? '专业技能' : 'Professional Skills',
                  lang === 'zh' ? '多项证书' : 'Certifications',
                ].map((chip, i) => (
            ...
            <div className="flex-shrink-0">
              <div className="relative float-animate">
                <div className="w-72 h-72 md:w-80 md:h-80 rounded-2xl overflow-hidden border-2 border-primary-100 shadow-2xl" style={{ boxShadow: '0 0 40px rgba(59,130,246,0.15), 0 25px 50px rgba(0,0,0,0.12)' }}>
                  ...
                  <span className="text-6xl font-bold text-primary-300">A</span>
                </div>
                </div>
                {/* Status badge */}
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            >
              ...
              <p className="text-primary-100 text-xs">your.email@example.com</p>
            </a>
            <a
            ...
            >
              ...
              <p className="text-primary-100 text-xs">ID: your_id</p>
            </a>
            <a
              href="#"
              target="_blank" rel="noopener noreferrer"
        ...
        <div className="max-w-6xl mx-auto flex flex-col items-center gap-5">
          ...
          <div className="w-full flex flex-col md:flex-row justify-between items-center gap-3 border-t border-gray-800 pt-5">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 bg-gradient-to-br from-primary-500 to-primary-700 rounded-lg flex items-center justify-center text-white text-sm font-bold">A</div>
